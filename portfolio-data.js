...
appProjectDetails = projectDetails.filter(function (element) {
  return element.projectType == APP;
});

webProjectDetails = projectDetails.filter(function (element) {
  return element.projectType == WEB;
});

uiuxProjectDetails = projectDetails.filter(function (element) {
  return element.projectType == UIUX;
});

console.log(appProjectDetails);
console.log(webProjectDetails);
console.log(uiuxProjectDetails);

var appData = appProjectDetails
  .map(
    (project) =>
      `
  <div  class=" col-lg-4 col-md-6 portfolio-item filter-app">
...
var uiuxData = uiuxProjectDetails
  .map(
    (project) =>
      `
...
document.getElementById("portfolioElement").innerHTML =
  appData + webData + uiuxData;
